    ...
    <xsl:template name="languageCodeText">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$code='afh'">
                <xsl:text>Afrihili (Artificial language)</xsl:text>
            </xsl:when>
            ...
            <xsl:when test="$code='frs'">
                <xsl:text>East Frisian</xsl:text>
            </xsl:when>
            ...
            <xsl:when test="$code='tlh'">
                <xsl:text>Klingon (Artificial language)</xsl:text>
            </xsl:when>
            ...
            <xsl:when test="$code='jbo'">
                <xsl:text>Lojban (Artificial language)</xsl:text>
            </xsl:when>
            ...
            <xsl:when test="$code='frr'">
                <xsl:text>North Frisian</xsl:text>
            </xsl:when>
            ...
            <xsl:otherwise>
                <!-- when 041$a is mapped to an authorised value list, this will show the
                description -->
